...
class StatusTestResources {
    ...
    companion object {
        ...
        val GROUP_1_STATUSES_RESPONSE = GetStatusesResponse(GROUP_1_STATUSES)
        ...
        val GROUP_2_STATUSES_RESPONSE = GetStatusesResponse(GROUP_2_STATUSES)
        ...
        val GROUP_2_UPDATED_STATUSES_REQUEST = UpdateStatusesRequest(AuthorizationTestResources.GROUP_2_GROUP_AUTHTOKEN, GROUP_2_UPDATED_STATUSES)

        val GROUP_2_INVALID_STATUSES_REQUEST = UpdateStatusesRequest(AuthorizationTestResources.GROUP_2_GROUP_AUTHTOKEN, GROUP_2_INVALID_STATUSES)
